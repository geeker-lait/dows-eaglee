...
CREATE TABLE IF NOT EXISTS `task_define`(
    `task_define_id` bigint(19) NOT NULL COMMENT '任务定义ID',
...
CREATE TABLE IF NOT EXISTS `task_project`(
    `task_project_id` bigint(19) NOT NULL COMMENT '任务项目ID',
...
CREATE TABLE IF NOT EXISTS `task_instance`(
    `task_instance_id` bigint(19) NOT NULL COMMENT '任务实例ID',
...
CREATE TABLE IF NOT EXISTS `task_counter`(
    `task_counter_id` bigint(19) NOT NULL COMMENT '任务计数器ID',
    `project_idenfifier` varchar(64) DEFAULT NULL COMMENT '项目标识',
...
CREATE TABLE IF NOT EXISTS `task_runtime`(
    `task_runtime_id` bigint(19) NOT NULL COMMENT '任务运行时ID',
...
CREATE TABLE IF NOT EXISTS `task_metric`(
    `task_metric_id` bigint(19) NOT NULL COMMENT '任务度量ID',
    `ip` varchar(64) DEFAULT NULL COMMENT '节点IP地址',
...
CREATE TABLE IF NOT EXISTS `task_config`(
    `task_config_id` bigint(19) NOT NULL COMMENT '任务配置ID',
...
CREATE TABLE IF NOT EXISTS `task_rule`(
    `task_rule_id` bigint(19) NOT NULL COMMENT '任务规则ID',
...
CREATE TABLE IF NOT EXISTS `task_setting`(
    `task_setting_id` bigint(19) NOT NULL COMMENT '任务设置ID',
